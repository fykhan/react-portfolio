...
import Loader from '../Loader'; // Importing Loader from the same directory

const DemoComputer = (props) => {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF('/demo_computer/computer.glb');
...
useGLTF.preload('./demo_computer/computer.glb');
